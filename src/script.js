...
loadMoreBtn.addEventListener('click', () => {
    projects.forEach((project) => { // оваа функција е за сите проекти односно лист ајтеми да се прикажат, односно не конкретно само тие што биле скриени туку кажуваме сите
